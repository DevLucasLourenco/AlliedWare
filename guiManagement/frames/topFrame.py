...
from guiManagement.buttons.patternButtons import *
...
class TopFrameForUsage(AbstractGlobalObject):
    ...
    def buildButtons(self):
        buttonDIF = PATTERN_BUTTON(buttonName="DIF", master=self.frameForUsage, gridRow=1, gridColumn=0, function=print, padTuple=((50, 0), (75, 0)))
        buttonCC = PATTERN_BUTTON(buttonName="CC", master=self.frameForUsage, gridRow=1, gridColumn=1, function=print, padTuple=((35, 0), (75, 0)))
        buttonCP = PATTERN_BUTTON(buttonName="CP", master=self.frameForUsage, gridRow=2, gridColumn=0, function=print, padTuple=((50, 0), (25, 0)))
        buttonHE = PATTERN_BUTTON(buttonName="HE", master=self.frameForUsage, gridRow=2, gridColumn=1, function=print, padTuple=((35, 0), (25, 0)))
